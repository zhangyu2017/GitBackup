...
def main():
    ...
    gPad.DrawFrame(0,0.00004,2.04,300)
    gPad.SetLogy(1)
    hlist1=fillFunc("7.7 GeV","pi+")
    hlist1[0].Draw("p")
    for i in range(1,9):
        hlist1[i].Draw("psame")
    ...
    gPad.SetRightMargin(0.07) 
    gPad.DrawFrame(0,0.00003,2.04,30)
    gPad.SetLogy(1)
    hlist2=fillFunc("7.7 GeV","ka+")
    hlist2[0].Draw("p")
    for i in range(1,9):
        hlist2[i].Draw("psame")
    ...
    pad.cd(3)
    gPad.SetLeftMargin(0.07) 
    gPad.DrawFrame(0,0.00002,2.04,60)
    gPad.SetLogy(1)
    hlist3=fillFunc("7.7 GeV","proton")
    hlist3[0].Draw("p")
    for i in range(1,9):
        hlist3[i].Draw("psame")
    ...
    pad.cd(4)
    gPad.SetRightMargin(0.07) 
    gPad.DrawFrame(0,0.00009,2.04,300)
    gPad.SetLogy(1)
    hlist4=fillFunc("7.7 GeV","pi-")
    hlist4[0].Draw("p")
    for i in range(1,9):
        hlist4[i].Draw("psame")
    ...
    pad.cd(6)
    gPad.SetLeftMargin(0.07) 
    gPad.DrawFrame(0,0.00003,2.04,0.3)
    gPad.SetLogy(1)
    hlist6=fillFunc("7.7 GeV","pbar")
    hlist6[0].Draw("p")
    for i in range(1,9):
        hlist6[i].Draw("psame")
    ...
    pad.cd(1)
    t1=TLatex(0.42,0.93,"Au+Au 7.7 GeV") 
