...
def main():
    ...
    pad.cd(3)
    gPad.SetLeftMargin(0.07) 
    gPad.DrawFrame(0,0.00002,2.04,30)
    gPad.SetLogy(1)
    hlist3=fillFunc("27 GeV","proton")
    hlist3[0].Draw("p")
    for i in range(1,9):
        hlist3[i].Draw("psame")
    ...
    pad.cd(4)
    gPad.SetRightMargin(0.07) 
    gPad.DrawFrame(0,0.00007,2.04,600)
    gPad.SetLogy(1)
    hlist4=fillFunc("27 GeV","pi-")
    hlist4[0].Draw("p")
    for i in range(1,9):
        hlist4[i].Draw("psame")
    ...
    pad.cd(1)
    t1=TLatex(0.42,0.93,"Au+Au 27 GeV") 
