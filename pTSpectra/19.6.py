...
def main():
    ...
    gPad.DrawFrame(0,0.00004,2.04,600)
    gPad.SetLogy(1)
    hlist1=fillFunc("19.6 GeV","pi+")
    hlist1[0].Draw("p")
    for i in range(1,9):
        hlist1[i].Draw("psame")
    ...
    pad.cd(3)
    gPad.SetLeftMargin(0.07) 
    gPad.DrawFrame(0,0.00002,2.04,20)
    gPad.SetLogy(1)
    hlist3=fillFunc("19.6 GeV","proton")
    hlist3[0].Draw("p")
    for i in range(1,9):
        hlist3[i].Draw("psame")
    ...
    pad.cd(4)
    gPad.SetRightMargin(0.07) 
    gPad.DrawFrame(0,0.00003,2.04,600)
    gPad.SetLogy(1)
    hlist4=fillFunc("19.6 GeV","pi-")
    hlist4[0].Draw("p")
    for i in range(1,9):
        hlist4[i].Draw("psame")
    ...
    gPad.SetLeftMargin(0.07)
    gPad.SetRightMargin(0.07) 
    gPad.DrawFrame(0,0.00001,2.04,30)
    gPad.SetLogy(1)
    hlist5=fillFunc("19.6 GeV","ka-")
    hlist5[0].Draw("p")
    for i in range(1,9):
        hlist5[i].Draw("psame")
    ...
    pad.cd(6)
    gPad.SetLeftMargin(0.07) 
    gPad.DrawFrame(0,0.000009,2.04,6)
    gPad.SetLogy(1)
    hlist6=fillFunc("19.6 GeV","pbar")
    hlist6[0].Draw("p")
    for i in range(1,9):
        hlist6[i].Draw("psame")
    ...
    pad.cd(1)
    t1=TLatex(0.42,0.93,"Au+Au 19.6 GeV") 
