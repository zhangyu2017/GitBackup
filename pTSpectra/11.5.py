...
def main():
    ...
    gPad.DrawFrame(0,0.00004,2.1,300)
    gPad.SetLogy(1)
    hlist1=fillFunc("11.5 GeV","pi+")
    hlist1[0].Draw("p")
    for i in range(1,9):
        hlist1[i].Draw("psame")
    ...
    gPad.SetRightMargin(0.07) 
    gPad.DrawFrame(0,0.00003,2.1,60)
    gPad.SetLogy(1)
    hlist2=fillFunc("11.5 GeV","ka+")
    hlist2[0].Draw("p")
    for i in range(1,9):
        hlist2[i].Draw("psame")
    ...
    pad.cd(3)
    gPad.SetLeftMargin(0.07) 
    gPad.DrawFrame(0,0.00002,2.1,30)
    gPad.SetLogy(1)
    hlist3=fillFunc("11.5 GeV","proton")
    hlist3[0].Draw("p")
    for i in range(1,9):
        hlist3[i].Draw("psame")
    ...
    pad.cd(4)
    gPad.SetRightMargin(0.07) 
    gPad.DrawFrame(0,0.00002,2.1,300)
    gPad.SetLogy(1)
    hlist4=fillFunc("11.5 GeV","pi-")
    hlist4[0].Draw("p")
    for i in range(1,9):
        hlist4[i].Draw("psame")
    ...
    gPad.SetLeftMargin(0.07)
    gPad.SetRightMargin(0.07) 
    gPad.DrawFrame(0,0.00003,2.1,30)
    gPad.SetLogy(1)
    hlist5=fillFunc("11.5 GeV","ka-")
    hlist5[0].Draw("p")
    for i in range(1,9):
        hlist5[i].Draw("psame")
    ...
    pad.cd(6)
    gPad.SetLeftMargin(0.07) 
    gPad.DrawFrame(0,0.00005,2.1,2)
    gPad.SetLogy(1)
    hlist6=fillFunc("11.5 GeV","pbar")
    hlist6[0].Draw("p")
    for i in range(1,9):
        hlist6[i].Draw("psame")
    ...
    pad.cd(1)
    t1=TLatex(0.42,0.93,"Au+Au 11.5 GeV") 
